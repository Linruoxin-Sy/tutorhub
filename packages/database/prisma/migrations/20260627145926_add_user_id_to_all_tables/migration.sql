...
-- CreateIndex
CREATE INDEX "class_session_override_user_id_idx" ON "class_session_override"("user_id");
...
-- CreateIndex
CREATE INDEX "class_rule_user_id_idx" ON "class_rule"("user_id");
...
-- CreateIndex
CREATE INDEX "student_course_user_id_idx" ON "student_course"("user_id");
...
-- AddForeignKey
ALTER TABLE "class_session_override" ADD CONSTRAINT "class_session_override_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "class_rule" ADD CONSTRAINT "class_rule_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "student_course" ADD CONSTRAINT "student_course_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
