        ...
        <form class="space-y-6" @submit.prevent="submit">
          ...
          <div class="space-y-2">
            ...
            <select
              id="status"
              v-model="data.status"
              class="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 dark:border-[#3a3a3a] dark:bg-[#202020] dark:text-white"
            >
          ...
          <button
            ...
            class="inline-flex w-full items-center justify-center cursor-pointer rounded-xl bg-blue-600 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-70"
          >
...
const { data, submit, isSubmitting } = useCourseCreateForm();
</script>
