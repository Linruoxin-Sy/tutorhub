...
export const datePickerUi: Partial<UIConfig> = {
  input:
    '!rounded-xl !border !border-gray-200 !bg-white !py-3 !text-sm !text-gray-900 !transition-all outline-none focus:!border-blue-500 focus:!ring-2 focus:!ring-blue-500/20 dark:!border-[#3a3a3a] dark:!bg-[#202020] dark:!text-white',
