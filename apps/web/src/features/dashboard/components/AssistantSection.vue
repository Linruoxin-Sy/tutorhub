<template>
  ...
  >
    ...
    >
      ...
      <div>
        <h2 class="text-sm font-semibold text-gray-900 dark:text-white">TutorHub AI Assistant</h2>
        <p class="text-xs text-gray-500 dark:text-gray-400">Smart analytics · Teaching guidance</p>
      </div>
